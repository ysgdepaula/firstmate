...
Load `projets` when the captain requests `/projets` or a per-project page, and after a project-changing event while that page is open, for its invocation and regeneration procedure.
