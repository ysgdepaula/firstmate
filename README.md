...
| `/projets`         | Open the per-project Lavish page, with the brain card as seventh project, for progress, decisions, management pages, costs, recent events, and meetings; see [Projects page](docs/configuration.md#projects-page-configprojetsjson-dataprojets-coutsjson-dataprojets-agendajson) for setup and the [projets skill](.agents/skills/projets/SKILL.md) for page-answer handling |
