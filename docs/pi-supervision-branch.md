...
A `done:` the pull-request delivery contract guard is actively holding is skipped, because it was never presented as a finish and its worker holds the guard's steer instead; a later done arriving after the guard's reminder budget is spent is presented unchanged and stays recoverable here.
