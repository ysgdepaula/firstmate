...
Three witnesses warrant it - the reminder budget or a published run-step outcome names that exact sentence, or the log's newest line is a done that satisfies the contract, so the task delivered afterwards and the handoff it replaced is moot.
