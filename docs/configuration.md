...
FM_PUSH_LOCK_DIR=                       # publication lock directory; scope and defaults: bin/fm-push-lock.sh header
FM_PUSH_LOCK_TIMEOUT_SECS=              # publication wait bound; semantics and default: bin/fm-push-lock.sh header
...
FM_TEST_JOBS=                           # worker ceiling; semantics: bin/fm-test-run.sh header
FM_TEST_QUEUE_TIMEOUT_SECS=             # suite queue wait bound; semantics and default: bin/fm-test-run.sh header
FM_TEST_QUEUE_DIR=                      # suite queue directory; scope and default: bin/fm-test-run.sh header
